			...
			<div class="grid_wrapper">
				...
				<div class="g_6" style="width: 100%">
					<div
						...
						<iframe src="<%=basePath %>report${path}" id="frame"
						...
						<div class="widget_contents noPadding">
							...
							<table class="tables">
								...
								<tbody>
									<tr>
										<td>实验原理</td>
										<td><div class="radio" id="uniform-undefined">
												<span><input type="radio" value="3.5"
													checked="checked" class="simple_form" name="theory" id=""
													style="opacity: 0;"></span>
											</div></td>
										<td><div class="radio" id="uniform-undefined">
												<span><input type="radio" value="2.5"
													class="simple_form" name="theory" id="" style="opacity: 0;"></span>
											</div></td>
										<td><div class="radio" id="uniform-undefined">
												<span><input type="radio" value="1.5"
													class="simple_form" name="theory" id="" style="opacity: 0;"></span>
											</div></td>
										<td><div class="radio" id="uniform-undefined">
												<span><input type="radio" value="0.5"
													class="simple_form" name="theory" id="" style="opacity: 0;"></span>
											</div></td>
									</tr>
									<tr>
										...
										<td><div class="radio" id="uniform-undefined">
												<span><input type="radio" value="3.5"
													checked="checked" class="simple_form" name="reagen" id=""
													style="opacity: 0;"></span>
											</div></td>
										<td><div class="radio" id="uniform-undefined">
												<span><input type="radio" value="2.5"
													class="simple_form" name="reagen" id="" style="opacity: 0;"></span>
											</div></td>
										<td><div class="radio" id="uniform-undefined">
												<span><input type="radio" value="1.5"
													class="simple_form" name="reagen" id="" style="opacity: 0;"></span>
									...
									<tr>
										...
										<td><div class="radio" id="uniform-undefined">
												<span><input type="radio" value="3.5"
													checked="checked" class="simple_form" name="instrument"
													id="instrument" style="opacity: 0;"></span>
											</div></td>
										<td><div class="radio" id="uniform-undefined">
												<span><input type="radio" value="2.5"
													class="simple_form" name="instrument" id="instrument"
													style="opacity: 0;"></span>
											</div></td>
										<td><div class="radio" id="uniform-undefined">
												<span><input type="radio" value="1.5"
									...
									<tr>
										...
										<td><div class="radio" id="uniform-undefined">
												<span><input type="radio" value="3.5"
													checked="checked" class="simple_form" name="experiment"
													id="experiment" style="opacity: 0;"></span>
											</div></td>
										<td><div class="radio" id="uniform-undefined">
												<span><input type="radio" value="2.5"
													class="simple_form" name="experiment" id="experiment" id=""
													style="opacity: 0;"></span>
											</div></td>
										<td><div class="radio" id="uniform-undefined">
												<span><input type="radio" value="1.5"
													class="simple_form" name="experiment" id="experiment"
													style="opacity: 0;"></span>
											</div></td>
										<td><div class="radio" id="uniform-undefined">
												<span><input type="radio" value="0.5"
									...
									<tr>
										...
										<td><div class="radio" id="uniform-undefined">
												<span><input type="radio" value="3.5"
													checked="checked" class="simple_form" name="labresult"
													id="labresult" style="opacity: 0;"></span>
											</div></td>
										<td><div class="radio" id="uniform-undefined">
												<span><input type="radio" value="2.5"
													class="simple_form" name="labresult" id="labresult"
													style="opacity: 0;"></span>
											</div></td>
										<td><div class="radio" id="uniform-undefined">
												<span><input type="radio" value="1.5"
									...
									<tr>
										...
										<td><div class="radio" id="uniform-undefined">
												<span><input type="radio" value="3.5"
													checked="checked" class="simple_form" name="conclusion"
													id="conclusion" style="opacity: 0;"></span>
											</div></td>
										<td><div class="radio" id="uniform-undefined">
												<span><input type="radio" value="2.5"
													class="simple_form" name="conclusion" id="conclusion"
													style="opacity: 0;"></span>
											</div></td>
										<td><div class="radio" id="uniform-undefined">
												<span><input type="radio" value="1.5"
									...
									<tr>
										<td>数字分数</td>
										<td colspan="4"><input class="simple_field" type="text"
											required="required" id="score" name="score"
											placeholder="请输入数字分数"></td>
									</tr>
									<tr>
										<td>评语</td>
										<td colspan="4"><textarea id="comment" name="comment"
												required="required" class="simple_field" rows="2" cols="1"
												placeholder="请输入少于150字的评语并确认后提交，提交后不能更改">${process}</textarea>
										</td>
									</tr>
								</tbody>
							</table>
