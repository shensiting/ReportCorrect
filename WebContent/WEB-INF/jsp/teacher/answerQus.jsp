...
<body>
	<div class="pd-20">
		<form action="" method="post" class="form form-horizontal"
			id="form-article-add">
			<div class="row cl">
				<label class="form-label col-1">问题：</label> <input
					value="${topic.cId}" id="qid" name="qid" type="hidden">
				<div class="formControls col-11">${topic.cContent}</div>
			</div>
			<div class="row cl"
			...
			$.ajax({
				...
				url : '<%=basePath%>student/codeCheck?code='+code+'',
					success : function(data) {
						if (data.success) {						
							document.forms[0].action = '<%=basePath%>teacher/answerQus.action';		
