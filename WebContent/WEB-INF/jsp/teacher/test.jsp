...
<body>
			...
			<dd>
				<ul>
					<li><a _href="<%=basePath%>teacher/teacherGrade"
						href="javascript:void(0)">班级关联管理</a></li>
						<li><a _href="<%=basePath%>teacher/gradeExam"
						href="javascript:void(0)">实验关联管理</a></li>
			...
			<dd>
				<ul>
					<li><a _href="<%=basePath%>student/uploadReport"
						href="javascript:void(0)">报告批改</a></li>
		...
		<div class="Hui-tabNav-wp">
			<ul id="min_title_list" class="acrossTab cl">
				<li class="active"><span title="报告编辑"
					data-href="<%=basePath%>teacher/reportManage">关联管理</span><em></em></li>
			</ul>
		</div>
	...
	<div id="iframe_box" class="Hui-article">
		<div class="show_iframe">
			...
			<iframe scrolling="yes" frameborder="0" src="<%=basePath%>teacher/reportManage"></iframe>
		</div>
	</div>
	</section>
