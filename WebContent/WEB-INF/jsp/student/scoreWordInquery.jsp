...
<body>
					...
					<c:forEach var="rRitem1" items="${reportRelativesbyStuid}">
						<tr class="text-c">
							...
							<td><a class="btn btn-success radius r mr-20"
								style="line-height: 1.6em; margin-top: 3px" href="javascript:;"
								onclick="article_add('查看批注','<%=basePath%>teacher/scoreWordShow?id='+${rRitem1.cId},'1000','600')">查看</a></td>
							<td><a class="btn btn-primary radius"
								style="text-decoration: none" id="edit"
								href="<%=basePath %>student/downLoadWordScore?id=${rRitem1.cId}"
								title="下载">下载</a></td>
							<td><c:choose>
	...
	<script type="text/javascript">
		...
		function editFunc(id){			
				layer_show("编辑报告","<%=basePath%>student/wordEdit?id="+id,'1000','600')			
		}
	</script>
</body>
</html>