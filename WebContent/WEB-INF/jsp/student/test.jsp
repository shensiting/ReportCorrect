...
<![endif]-->
<link href="<%=basePath%>users/css/H-ui.min.css" rel="stylesheet" type="text/css" />
<link href="<%=basePath%>users/css/H-ui.admin.css" rel="stylesheet" type="text/css" />
<link href="<%=basePath%>users/skin/default/skin.css" rel="stylesheet" type="text/css" id="skin" />
<link href="<%=basePath%>users/lib/Hui-iconfont/1.0.1/iconfont.css" rel="stylesheet" type="text/css" />
<link href="<%=basePath%>users/css/style.css" rel="stylesheet" type="text/css" />
<!--[if IE 6]>
...
<script type="text/javascript" src="<%=basePath%>users/lib/jquery/1.9.1/jquery.min.js"></script> 
<script type="text/javascript" src="<%=basePath%>users/lib/layer/1.9.3/layer.js"></script> 
<script type="text/javascript" src="<%=basePath%>users/js/H-ui.js"></script> 
<script type="text/javascript" src="<%=basePath%>users/js/H-ui.admin.js"></script> 
