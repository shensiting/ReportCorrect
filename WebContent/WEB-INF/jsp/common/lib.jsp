...
<link rel="stylesheet" href="<%=basePath_lib %>manage/css/bootstrap.min.css" />
<link rel="stylesheet" href="<%=basePath_lib %>manage/css/bootstrap-responsive.min.css" />
<link rel="stylesheet" href="<%=basePath_lib %>manage/css/uniform.css" />
<link rel="stylesheet" href="<%=basePath_lib %>manage/css/select2.css" />
<link rel="stylesheet" href="<%=basePath_lib %>manage/css/unicorn.main.css" />
<link rel="stylesheet" href="<%=basePath_lib %>manage/css/unicorn.grey.css" class="skin-color" />
...
<!-- Dialog Js -->
<script src="<%=basePath_lib %>js/jquery.bootstrap.teninedialog.v3.min.js"></script> 
<!-- validate -->
