	...
	<div id="content">
		...
		<div id="breadcrumb">
			<a href="<%=basePath%>manage/index" title="主页" class="tip-bottom"><i class="icon-home"></i>
				首页</a> <a href="#" class="current">用户信息管理</a><a href="#" class="current">增加/修改用户信息</a>
		</div>
					...
					<div class="widget-box">
						...
						<div class="widget-content nopadding">
							<form class="form-horizontal" method="post"
								action="<%=basePath %>manage/addUser.action"
								name="basic_validate" id="basic_validate">
								<div class="control-group">
									<label class="control-label" style="font-size: 20px">账号</label>
									<div class="controls">
										<!-- 隐藏值 id -->
										<input type="hidden" name="id" value="${user.cId }" /> <input
											type="text" name="username" value="${user.cUserName }"
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" name="password" value="${user.cPassword }"
											style="height: 33px" required="required" />
									</div>
								</div>
								<div class="control-group">
									<label class="control-label" style="font-size: 20px">权限</label>
									<div class="controls">
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="submit" value="保存" class="btn btn-primary" /> <input
											...
											onclick="location='<%=basePath%>manage/indexUser'"
