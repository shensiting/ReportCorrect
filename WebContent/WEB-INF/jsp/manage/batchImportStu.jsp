...
function load(){         	
	...
	if(file==""){
		...
		document.forms[0].action='<%=basePath%>manage/importExcel';
...
<body>
	<div class="pd-20">
		...
		<div class="row cl">
			<img src="<%=basePath%>users/images/导入EXCEL示例.jpg" />
		</div>

		<div class="row cl"
			style="margin-top: 4%; margin-left: 60%; height: 50px">
			<p>
				导入学生模板.xlsx <a style="width: 150px;" class="btn btn-primary radius"
					href="../gzhmc/data/导入学生模板.xlsx">下载模板</a>
			</p>
		</div>
		<hr>
