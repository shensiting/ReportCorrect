...
<body>
	...
	<div class="pd-20">
			...
			<a
				...
				onclick="article_add('专业添加','<%=basePath%>manage/addMajor','450','200','200')" href="javascript:;"><i
	...
	<script type="text/javascript">
		...
		function editFunc(id){
				...
				layer_show("修改专业","<%=basePath%>manage/addMajor.html?id="+id,450,200)
