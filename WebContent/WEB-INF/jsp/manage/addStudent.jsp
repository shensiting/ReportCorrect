	...
	<div id="content">
		...
		<div id="breadcrumb">
			<a href="<%=basePath%>manage/index" title="主页" class="tip-bottom"><i class="icon-home"></i>
				首页</a> <a href="#" class="current">学生信息管理</a><a href="#" class="current">增加/修改学生信息</a>
		</div>
					...
					<div class="widget-box">
						...
						<div class="widget-content nopadding">
							<form class="form-horizontal" method="post"
								action="<%=basePath%>manage/addStudent.action"
								name="basic_validate" id="basic_validate">
								<div class="control-group">
									<label class="control-label" style="font-size: 20px">学号</label>
									<div class="controls">
										<!-- 隐藏值 学生id -->
										<input type="hidden" name="id"
											value="${studentGrade.getcUserId()}" /> <input type="text"
											name="Studentnum" value="${studentGrade.getcStudentNumber()}"
											style="height: 33px" required="required" />
									</div>
								</div>
								<div class="control-group">
									<label class="control-label" style="font-size: 20px">姓名</label>
									<div class="controls">
										<input type="text" name="Studentname"
											value="${studentGrade.getcName()}" style="height: 33px"
											required="required" />
									</div>
								</div>

								<div class="control-group">
									<label class="control-label" style="font-size: 20px">身份证号</label>
									<div class="controls">
										<input type="text" name="IDnum"
											value="${studentGrade.getcIDNumber()}" style="height: 33px"
											required="required" />
									</div>
								</div>
								...
								<div class="control-group">
									...
									<div class="controls">
										<select name="cYearClass" id="cYearClass" style="width: 300px">
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="submit" value="保存" class="btn btn-primary" /> <input
											...
											onclick="location='<%=basePath%>manage/indexStudent'"
