...
public class GradeController extends BaseController {
	...
	public ModelAndView indexGradeExam(HttpServletRequest request, HttpServletResponse response) {
	...
	private boolean qualify(int cGradeId) {
		if (gradeMapper.getByStuGradeId(cGradeId) == 0 && gradeMapper.getByGraExamGradeId(cGradeId) == 0
				&& gradeMapper.getByteaGradeGradeId(cGradeId) == 0)
			return true;
		else
			return false;
	}
