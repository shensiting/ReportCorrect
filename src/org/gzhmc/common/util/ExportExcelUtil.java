...
public class ExportExcelUtil {
	...
	public static <T> HSSFWorkbook export(HttpServletResponse response, String fileName, String[] excelHeader,
	   List<ExcelMessage> dataList) throws Exception {
	  // 设置请求
	  ...
	  // System.out.println("titleArray[i]:"+tempArray[0]+"fieldArray[i]:"+tempArray[1]);
	  }
	  // 在sheet中添加标题行
	...
	//  System.out.println(it);
	  ...
	  while (it--!=0) {
	   ...
	   for (int i = 0; i < fieldArray.length; i++) {
	    ...
	    switch (fieldArray[i]) {
		case "cCollegeName":
			value=dataList.get(it).getcCollegeName();
			break;
		case "cYearClass":
			value=dataList.get(it).getcYearClass();
					break;
		case "cMajorName":
			value=dataList.get(it).getcMajorName();
			break;
		case "cClass":
			value=dataList.get(it).getcClass();
			break;
		case "cName":
			value=dataList.get(it).getcName();
			break;
...
//	    
//	    if(fieldArray[i].equals("cCollegeName")){
//	    	//System.out.println(dataList.get(it).getcCollegeName());
//	    	value=dataList.get(it).getcCollegeName();
//	    	
//	    }else if(fieldArray[i].equals("cYearClass")){
//	    	//System.out.println(dataList.get(it).getcClass());
//	    	value=dataList.get(it).getcYearClass();
//	    }
//		else if(fieldArray[i].equals("cMajorName")){
//			//System.out.println(dataList.get(it).getcMajorName());
//			value=dataList.get(it).getcMajorName();	
//			    }
//		else if(fieldArray[i].equals("cClass")){
//			//System.out.println(dataList.get(it).getcClass());
//			value=dataList.get(it).getcClass();
//		}
//		else if(fieldArray[i].equals("cName")){
//			//System.out.println(dataList.get(it).getcName());
//			value=dataList.get(it).getcName();
//		}
//		else if(fieldArray[i].equals("cExperimentName")){
//			//System.out.println(dataList.get(it).getcReportNum());
//			value=dataList.get(it).getcExperimentName();
//		}
//		else if(fieldArray[i].equals("cReportNum")){
//			//System.out.println(dataList.get(it).getcReportNum());
//			value=dataList.get(it).getcReportNum();
//		}
//		else if(fieldArray[i].equals("cSum")){
//			//System.out.println(dataList.get(it).getcSum().toString());
//			value=dataList.get(it).getcSum().toString();
//		}
//	    
