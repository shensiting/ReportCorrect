...
public class ClassLoaderUtil {
	...
	public static void main(String[] args) throws MalformedURLException {
		...
		System.out.println(ClassLoaderUtil.getExtendResource("../../WebContent/gzhmc/picture"));
		//System.out.println(ClassLoaderUtil.getClassLoader().getResource("../../WebContent/gzhmc/report/1111.docx").toString());
	}
